...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    icons: {
      icon: [{ url: '/orbit-favicon-v4.png', sizes: '64x64', type: 'image/png' }, { url: '/orbit-icon-v4-192.png', sizes: '192x192', type: 'image/png' }],
      shortcut: '/orbit-favicon-v4.png',
      apple: [{ url: '/orbit-apple-touch-v4.png', sizes: '180x180', type: 'image/png' }],
    },
...
export default function RootLayout({
  ...
  return (
    <html lang="tr" suppressHydrationWarning>
      <head><link rel="manifest" href="/manifest.webmanifest?v=4"/><meta name="theme-color" content="#15131a"/><script dangerouslySetInnerHTML={{ __html: authClientScript }}/><script dangerouslySetInnerHTML={{ __html: themeBootScript }}/><script dangerouslySetInnerHTML={{ __html: startupScript }}/></head>
      <body
