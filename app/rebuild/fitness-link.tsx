...
export const fitnessIntent = (origin:string) => `intent://open#Intent;scheme=profitness;package=com.cosmibit.profitness;S.browser_fallback_url=${encodeURIComponent(`${origin}/fitness`)};end`;
const subscribe = () => () => {};
